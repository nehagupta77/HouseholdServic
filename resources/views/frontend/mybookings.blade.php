        ...
        <table class="table table-bordered table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $booking->mobile ?? 0}}</td>               
                    <td>{{ $booking->product->price->price ?? 0}}</td>               
                    <td>{{ $booking->status ?? 0}}</td>   
                    <td>            
                    @if($booking->status !='Approved')
                    <a href='{{ route("stripe.checkout", $booking->id)}}' class="btn btn-sm btn-danger" target='_blank'>Pay</a> |
                    @endif
                    <a href='{{ route("product.detail", $booking->product->id)}}' class="btn btn-sm btn-danger" target='_blank'>View</a></td>
                </tr>
                @empty
